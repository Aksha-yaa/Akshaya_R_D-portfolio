  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="glass rounded-xl p-5 sm:p-6 group hover:glow-sm transition-all duration-300 relative overflow-hidden"
      >
        ...
        <div className="relative">
          <div className="flex items-start justify-between mb-3">
            <motion.div
              ...
              className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-all"
            >
...
const FeaturedArticles = () => (
  <section id="articles" className="py-24 px-4 sm:px-6">
    <div className="container mx-auto max-w-5xl">
      <SectionHeading title="Featured Articles" subtitle="Thoughts on engineering, security, and software craft." />
